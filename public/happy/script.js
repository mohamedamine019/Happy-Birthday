...
const images = [
  { src: '', alt: 'Birthday memory 1', caption: 'PI DAY' },
  { src: '', alt: 'Birthday memory 2', caption: 'seminere' },
  { src: '', alt: 'Birthday memory 3', caption: 'cute' },
...
const galleryPhotos = [
  { src: '', alt: 'Birthday memory 1', caption: 'cute' },
  { src: '', alt: 'Birthday memory 2', caption: 'seminere' },
  { src: '', alt: 'Birthday memory 3', caption: 'PI DAy' },
  /* { src: 'placeholder.jpg', alt: 'Birthday memory 4', caption: 'Coffee shop meetup' },
  { src: 'placeholder.jpg', alt: 'Birthday memory 5', caption: 'Concert night' },
...
function handleChoice(choice) {
  if (choice === 'yes') {
    ...
    alert('Thank You So much but khyrt NO Then mnkhlikch dir Yes (I am so sorry but ktbtlk one choose)!');
  }
  ...
  // Optionally, add a visual indicator (e.g., grayed-out buttons)
...
// Countdown Timer
/* function startCountdownToEvent(targetDate) {
  ...
  function updateCountdown() {
    ...
    if (timeLeft <= 0) {
      ...
      countdownOverlay.classList.add('hidden'); // Hide countdown overlay
  ...
  // Disable scrolling while countdown is active
...
// Set target date (e.g., May 4, 2025, 12:00 PM)
/* const targetDate = new Date('2025-05-27T00:00:00').getTime();
startCountdownToEvent(targetDate); */
